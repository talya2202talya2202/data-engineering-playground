...
<img src="./assets/architecture.png" alt="ETL architecture — streaming pipeline (always on) + scheduled Airflow batch layer, both reading and writing the same Iceberg tables" width="700">
