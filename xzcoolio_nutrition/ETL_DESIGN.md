...
In either direction the system must support **scale**, **expensive rate-limited enrichment** against the nutrition API, **per-user personalization**, and a single source of truth that feeds analytics, alerts, and ML.
